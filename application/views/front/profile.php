    ...
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <form action="<?php echo base_url().'profile/edit/'.$loggedUser['user_id']?>" method="POST">
                <h4 class="pb-4 border-bottom">Configurações de Conta</h4>
                <div class="py-2">
                    <div>
                    ...
                    <div class="py-3 pb-4 border-bottom">
                        <button type="submit" class="btn btn-primary mr-3">Salvar Alteração</button>
