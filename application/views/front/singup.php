...
<body style="background-color: #ffcad5;">
    <div class="wrapper container" style="background-color: #CCECFC;">

        <h1 class="text-center my-3">Criar sua Conta</h1>
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" name="myForm" id="myForm"
            ...
            <div class="row">
                ...
                <?php echo (form_error('username') != "") ? 'is-invalid' : '';?>" name="username" id="userName"
                            placeholder="Informe seu Usuário" value="<?php echo set_value('username')?>">
                ...
                <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname" id="lastName"
                            placeholder="Informe seu Sobrenome" value="<?php echo set_value('lastname')?>">
                ...
                <?php echo (form_error('password') != "") ? 'is-invalid' : '';?>" name="password" id="pass"
                            placeholder="Senha" value="<?php echo set_value('password')?>">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="firstname">Informe seu Primeiro Nome</label>
                        <input type="text" class="form-control
                <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname" id="firstName"
                            placeholder="Informe seu Primeiro Nome" value="<?php echo set_value('firstname')?>">
                ...
                <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" name="phone" placeholder="Contato"
        ...
        <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>"
            ...
            <p>Já se registrou-se? <a href="<?php echo base_url().'login/index';?>">Logar-se Agora!</a></p>
        </form>
    </div>
