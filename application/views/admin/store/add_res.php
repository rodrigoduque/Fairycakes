<div class="conatiner">
    <form action="<?php echo base_url().'admin/store/create_restaurant';?>" method="POST"
        ...
        <h3 class="mb-3 p-2 text-center mb-3">Adicionar Detalhes da Nova Loja </h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Nome da loja</label>
                    <input type="text" name="res_name" id="rname" class="form-control
                    <?php echo (form_error('res_name') != "") ? 'is-invalid' : '';?>" placeholder="Add Loja"
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label">Dias em Funcionamento</label>
