<div class="container">
    <div class="container shadow-container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <input class="form-control mb-3" id="myInput" type="text" placeholder="Procurar .." style="width:50%;">
        </div>
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td> <button type="button" class="btn btn-success"><span class="fa fa-check-circle"aria-hidden="true"></span> Entregue</button>
                        ...
                        <td>
                            <a href="<?php echo base_url().'admin/orders/processOrder/'.$order['o_id'];?>"
                                class="btn btn-info mb-1">                               <i class="fas fa-arrow-alt-circle-right"></i> Em Processo</a>
