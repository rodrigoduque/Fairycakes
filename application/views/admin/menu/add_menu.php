<div class="conatiner">
    <form action="<?php echo base_url().'admin/menu/create_menu';?>" method="POST" id="myForm" name="myForm"
        ...
        <h3 class="mb-3 text-center">Adicionar Item</h3>
        <div class="form-group">
            <label class="control-label">Selecione a Loja</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Entre com o nome" value="<?php echo set_value('name'); ?>">
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Entre com o Preço R$" value="<?php echo set_value('price'); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Sobre" value="<?php echo set_value('about'); ?>">
        ...
        <a href="<?php echo base_url().'admin/menu/index'?>" class="btn btn-secondary">Voltar</a>
    </form>
</div>
<script>
