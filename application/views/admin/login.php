...
<body>
    <div class="conatiner">
        <h1 class="text-center mt-3">Painel Administrativo</h1>
        <p class="text-center mb-4">Por Favor, realize o login para continuar!</p>
        <?php
      ...
      ?>
        <form action="<?php echo base_url().'admin/login/authenticate' ;?>" name="loginform" id="loginform"
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control my-2" name="username" id="username" placeholder="Usuário">
                <span></span>
            </div>
            <?php echo form_error('username'); ?>
            <div class="form-group">
                <label for="password">Senha</label>
                <input type="password" class="form-control my-2" name="password" id="password" placeholder="Senha">
                <span></span>
            </div>
            <?php echo form_error('password'); ?>
            <button type="submit" class="btn btn-info btn-block mb-2">Entrar</button>
        </form>
    </div>
    <script>
