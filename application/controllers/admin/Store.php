...
class Store extends CI_Controller {
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Loja Adicionada com Sucesso');
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('res_success', 'Loja Atualizada com Sucesso');
                    redirect(base_url(). 'admin/store/index');
    ...
    public function delete($id){
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'Loja not found');
